...
<img src="{{asset('assets/images/travel.png')}}" class="img-responsive" alt="logo" width="100%">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6">
            <div class="serviceBox">
                <div class="service-icon">
                    <img src="{{asset('assets/images/Malls.jpg')}}" class="img-responsive" alt="logo" style="height:200px;width:300px">
                </div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="serviceBox blue">
                <div class="service-icon">
                     <img  src="{{asset('assets/images/bangkok.jpg')}}" class="img-responsive" alt="logo" style="height:200px;width:300px">
                </div>
                <div class="service-content">
		...
		<div class="col-md-3 col-sm-6">
            <div class="serviceBox blue">
                <div class="service-icon">
                     <img src="{{asset('assets/images/singapore.jpeg')}}" class="img-responsive" alt="logo" style="height:200px;width:300px">
                </div>
                <div class="service-content">
		...
		<div class="col-md-3 col-sm-6">
            <div class="serviceBox blue">
                <div class="service-icon">
                    <img src="{{asset('assets/images/andaman.png')}}" class="img-responsive" alt="logo" style="height:200px;width:300px">
                </div>
                <div class="service-content">
